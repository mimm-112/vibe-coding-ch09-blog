...
이미 배포되어 있습니다 → **https://vibe-coding-ch09-blog.vercel.app**
...
로컬 `.env.local` 값을 그대로 Vercel에 올립니다. 값이 화면에 출력되지 않습니다.
...
<https://vercel.com/yooo18/vibe-coding-ch09-blog/settings/environment-variables>

`.env.local.example` 에 적힌 키를 하나씩 추가한 뒤 **Redeploy** 를 누르면 됩니다.
